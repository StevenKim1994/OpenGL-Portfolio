...
void main()
{
	...
	d += I(r()); add(); d += S(r()); add(); space(); d += S(r()); add(); d += T(r()); add(); d += V(r()); add(); d+= E(r()); add(); d+= N(r()); space();
	newline();
	d += H(r()); add(); d += E(r()); add(); space(); d+= G(r()); add(); d+= E(r()); add(); d+= N(r()); add(); d+= I(r()); d+= U(r()); add(); d+= S(r()); add;
